...
namespace GeneralSystemsVehicle\Zoom\Guzzle;

use GeneralSystemsVehicle\Zoom\Events\RequestExceptionWasThrown;
use GeneralSystemsVehicle\Zoom\Guzzle\Backoff;
...
class Api
{
    ...
    public function __construct($options = [])
    {
        ...
        $this->client = new Client([
            'base_uri' => Config::get('zoom.base_uri'),
            'handler' => $stack,
            'headers' => [
